...
public class Client {
	...
	void start() {
		...
		if (host == null) return;
		String portStr = JOptionPane.showInputDialog(null, "Port:", "5000");
		if (portStr == null) return;
		int port;
		try { port = Integer.parseInt(portStr.trim()); } catch (Exception e) { return; }
		String name = JOptionPane.showInputDialog(null, "Your display name:", "Client");
		...
		ChatWindow w = new ChatWindow(socket, name, true);
		w.setTitle(name + " - Client");
		w.setVisible(true);
	}
